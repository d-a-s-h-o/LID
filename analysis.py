...
with open("english_probabilities.json", "r") as english_probabilities: # Open the file.
    english_probabilities = json.load(english_probabilities) # Load the data.
...
for character in characters: # Loop through each character.
    english[character] = english_probabilities[character] # Add the probability to the dictionary.

# Create a list of the probabilities of each character in French.
french = {} # Create a dictionary to store the probabilities.
for character in characters: # Loop through each character.
    french[character] = french_probabilities[character] # Add the probability to the dictionary.
...
ax.set_xlabel("Character") # Set the x-axis label.
ax.set_ylabel("Probability") # Set the y-axis label.
ax.set_title("Character Frequency") # Set the title.
